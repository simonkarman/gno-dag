...
export function Display({ displayInformation }: { displayInformation: DisplayInformation }) {
  ...
  return <>
    <div className="p-2 pt-20 space-y-4">
    ...
    <div className="absolute right-2 top-20 p-2 bg-zinc-200 rounded-lg shadow flex flex-col gap-2 active-hint text-black text-center">
