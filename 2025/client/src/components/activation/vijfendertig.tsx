...
export default function Vijfendertig(props: ActivationProps) {
  ...
  return <>
    ...
    {others.length > 0 && <p className='text-zinc-400'>Psst. Hebben jullie door dat {others.join(' en ')} ook mee {others.length < 2 ? 'luistert' : 'luisteren'}?</p>}
    ...
    <ul className='list-disc pl-6 text-zinc-800 font-mono'>
      ...
      <li>
        <span className='font-bold'>SLEUTEL</span>: 35 (zegge Vijfendertig)
      </li>
    </ul>
  </>;
}
