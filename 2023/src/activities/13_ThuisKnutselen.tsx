...
export function ThuisKnutselen() {
  return <div>
    <p className="mb-4">
      ...
      Gelukkig waren piraat Fohne en zijn papegaai Kuek vergeten om de kist helemaal leeg te halen.
    </p>
    ...
    <p className="mb-4">
      Nu is het tijd om de kist weer te vullen. Luister goed naar de uitleg van Marjolein.
